...
<body>
    <div class="login-container">
        ...
        <div class="brand-badge">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="UD Makmur Jaya">
        </div>
        ...
        <form method="POST" action="<?php echo e(route('admin.login')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" placeholder="Masukkan Gmail" value="<?php echo e(old('email')); ?>" required autofocus>
