...
<div class="card">
    ...
    <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" name="whatsapp_number" value="<?php echo e($settings['whatsapp_number'] ?? ''); ?>" class="form-control" placeholder="+62 852-2546-1504">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="maps_embed" class="form-control" rows="3" placeholder="<iframe src=\"https://www.google.com/maps/embed?...\"></iframe>"><?php echo e($settings['maps_embed'] ?? ''); ?></textarea>
