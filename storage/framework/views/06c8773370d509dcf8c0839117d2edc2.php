...
<?php $__env->startSection('title', 'Tambah Testimoni'); ?>
    ...
    <form method="POST" action="<?php echo e(route('admin.testimonials.store')); ?>" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="business_name" value="<?php echo e(old('business_name')); ?>" class="form-control" required placeholder="Contoh: RM Padang Maju">
            </div>
            <div class="form-group">
                <label>Tipe Bisnis</label>
                <input type="text" name="business_type" value="<?php echo e(old('business_type')); ?>" class="form-control" placeholder="Contoh: Restoran, Catering, Hotel...">
            </div>
            <div class="form-group">
                <label>Rating <span style="color:red">*</span></label>
                <select name="rating" class="form-control" required>
                    <?php for($i=5;$i>=1;$i--): ?>
                        <option value="<?php echo e($i); ?>" <?php echo e(old('rating',5)==$i?'selected':''); ?>><?php echo e($i); ?> Bintang <?php echo e(str_repeat('★',$i)); ?></option>
                    <?php endfor; ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="testimonial" class="form-control" rows="4" required placeholder="Tuliskan pengalaman pelanggan..."><?php echo e(old('testimonial')); ?></textarea>
        </div>

        <div class="form-group">
            <label>Foto (opsional)</label>
            <input type="file" name="photo" class="form-control" accept="image/*">
            <small style="color:#888">Format: JPG, PNG, GIF. Berukuran bebas.</small>
        </div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ud-makmurjaya\resources\views/admin/testimonials/create.blade.php ENDPATH**/ ?>