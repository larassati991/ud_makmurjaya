        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-lg">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
                    <a href="https://wa.me/<?php echo e(App\Models\Setting::get('whatsapp_number')); ?>" target="_blank" class="group flex flex-col items-center gap-3 rounded-2xl border border-gray-200 p-5 text-center transition hover:border-red-600 hover:bg-red-50">
                        ...
                        <p class="text-sm text-gray-500 group-hover:text-gray-700">Chat langsung via <?php echo e(App\Models\Setting::get('phone_1_label')); ?></p>
                    </a>
                    <a href="<?php echo e(App\Models\Setting::get('instagram', 'https://instagram.com')); ?>" target="_blank" class="group flex flex-col items-center gap-3 rounded-2xl border border-gray-200 p-5 text-center transition hover:border-red-600 hover:bg-red-50">
                    ...
                    <a href="<?php echo e(App\Models\Setting::get('tiktok', 'https://tiktok.com')); ?>" target="_blank" class="group flex flex-col items-center gap-3 rounded-2xl border border-gray-200 p-5 text-center transition hover:border-red-600 hover:bg-red-50">
