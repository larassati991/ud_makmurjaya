    ...
    <div class="container mx-auto px-4">
        <div class="bg-gradient-to-br from-[#7B0000] to-[#3D0000] rounded-3xl overflow-hidden shadow-lg px-8 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                     <a href="https://wa.me/<?php echo e(preg_replace('/\\D+/', '', App\Models\Setting::get('whatsapp_number', '+62 852-2546-1504'))); ?>?text=Halo! Saya tertarik untuk info pricelist & order retail" 
                   target="_blank"
    ...
    <div class="container mx-auto px-4">
        <div class="bg-gray-50 rounded-3xl overflow-hidden shadow-lg flex flex-col lg:flex-row" style="min-height: 320px;">
            ...
            <div class="flex-1 min-h-[260px]">
                ...
                <iframe 
                    src="<?php echo e($mapsUrl ?: 'https://www.google.com/maps?q=UD.+Daging+makmur+jaya,+Krsak,+Bangsri,+Kabupaten+Jepara,+Jawa+Tengah&output=embed'); ?>" 
                    width="100%" 
                    height="100%" 
