                    ...
                    <div class="p-6">
                        ...
                        @if($product->weight)
                            <p class="text-sm text-gray-500 mb-4 flex items-center">
                                ...
                                <span class="font-semibold">Berat:</span> {{ number_format($product->weight, 0, ',', '.') }}g
                            </p>
                        @endif
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-8 md:p-12 text-center text-white">
            ...
            <a href="https://wa.me/{{ App\Models\Setting::get('whatsapp_number', '6281234567890') }}?text=Halo, saya butuh bantuan memilih produk {{ $category->name }}" 
               target="_blank"
