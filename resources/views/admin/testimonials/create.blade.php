    ...
    <form method="POST" action="{{ route('admin.testimonials.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="business_name" value="{{ old('business_name') }}" class="form-control" required placeholder="Contoh: RM Padang Maju">
            </div>
            <div class="form-group">
                <label>Tipe Bisnis</label>
                <input type="text" name="business_type" value="{{ old('business_type') }}" class="form-control" placeholder="Contoh: Restoran, Catering, Hotel...">
            </div>
            <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea name="testimonial" class="form-control" rows="4" required placeholder="Tuliskan pengalaman pelanggan...">{{ old('testimonial') }}</textarea>
        </div>
