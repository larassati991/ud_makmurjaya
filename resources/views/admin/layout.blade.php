...
<head>
    ...
    <title>@yield('title') - Admin UD Makmur Jaya Daging</title>
...
<body>
    <div class="sidebar">
        <div class="sidebar-brand">
            <img src="{{ asset('images/logo.png') }}" alt="UD Makmur Jaya" class="sidebar-logo">
            <h2>Admin Panel</h2>
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="{{ route('admin.categories.index') }}" class="@if(str_starts_with(Route::currentRouteName() ?? '', 'admin.categories')) active @endif">📁 Kategori</a></li>
            <li><a href="{{ route('admin.products.index') }}" class="@if(str_starts_with(Route::currentRouteName() ?? '', 'admin.products')) active @endif">🛍️ Produk</a></li>
    ...
    <div class="main-content">
        <div class="navbar">
            ...
            <div class="top-actions">
                <span class="admin-user-chip"><span class="admin-user-avatar">A</span> {{ session('admin_user_name', 'Admin') }}</span>
                <a href="{{ route('admin.logout') }}" class="btn btn-danger btn-sm" onclick="return confirm('Keluar dari admin panel?')">Logout</a>
            </div>
        </div>
