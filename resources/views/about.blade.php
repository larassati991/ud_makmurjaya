...
@section('title', 'Tentang Kami - UD MAKMUR JAYA DAGING')
...
<section class="bg-gradient-to-r from-primary to-red-700 text-white py-20">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl">{{ App\Models\Setting::get('company_name') }}</p>
    </div>
</section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div class="md:col-span-2 p-10 flex flex-col justify-center">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-bold text-gray-800 text-lg">{{ App\Models\Setting::get('owner_name', 'Pimpinan') }}</p>
...
<section class="bg-gradient-to-r from-primary to-red-700 text-white py-16">
    <div class="container mx-auto px-4 text-center">
        ...
        <a href="https://wa.me/{{ preg_replace('/\\D+/', '', App\Models\Setting::get('whatsapp_number', '+62 852-2546-1504')) }}?text=Halo, saya ingin bermitra dengan UD MAKMUR JAYA DAGING" 
           target="_blank"
