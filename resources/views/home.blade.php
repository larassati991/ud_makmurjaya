...
@section('title', 'UD MAKMUR JAYA DAGING - Siap Suplai Daging ke Seluruh Indonesia')
    ...
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                <strong class="text-[#6B3434]">{{ App\Models\Setting::get('company_name') }}</strong> menyediakan berbagai pilihan daging lokal dan impor.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" x-data="{ activeTab: 'halal' }">
            ...
            <div class="relative">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl h-[500px]">
                    ...
                    <!-- Image for Higienis -->
                    <img src="{{ asset('images/standarhigienis.png') }}" 
                    ...
                    <img src="{{ asset('images/coldsupply.png') }}" 
                ...
                <a href="{{ route('products.category', $category->slug) }}" class="block">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                        <div class="relative overflow-hidden h-64">
                            ...
                            @else
                                <div class="w-full h-full bg-gradient-to-br from-red-800 to-red-600 flex items-center justify-center">
                                    <span class="text-white text-7xl font-bold">{{ substr($category->name, 0, 1) }}</span>
                                </div>
                            @endif
                            <!-- Overlay gradasi -->
                        ...
                        <div class="p-6 bg-gray-50">
                            <h3 class="text-2xl font-bold mb-3 text-gray-800 group-hover:text-red-600 transition-colors">{{ $category->name }}</h3>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-gray-50 border border-gray-100 rounded-2xl p-6 hover:shadow-md transition-shadow duration-300 flex flex-col">
                ...
                {{-- Teks Testimoni --}}
                <p class="text-gray-600 text-sm leading-relaxed flex-1 mb-5">{{ $testimonial->testimonial }}</p>
                ...
                <div class="border-t border-gray-200 pt-4 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-xs">{{ $testimonial->business_name }}@if($testimonial->business_type) · {{ $testimonial->business_type }}@endif</p>
                    </div>
                </div>
        ...
        <div class="bg-gradient-to-r from-[#C0392B] via-[#8B1A1A] to-[#6B3434] rounded-3xl overflow-hidden shadow-2xl">
            <div class="grid grid-cols-1 lg:grid-cols-5 items-stretch">
                ...
                <div class="lg:col-span-3 p-8 md:p-12 lg:p-16 text-white">
                    <h2 class="text-3xl md:text-4xl font-bold mb-6">Prakata – {{ App\Models\Setting::get('company_name', 'UD MAKMUR JAYA DAGING') }}</h2>
                    
                    <div class="space-y-4 text-base md:text-lg leading-relaxed mb-8">
                        <p>
                            Sejak berdiri, <strong>{{ App\Models\Setting::get('company_name', 'UD MAKMUR JAYA DAGING') }}</strong> telah dipercaya oleh banyak mitra bisnis. Komitmen kami adalah menjaga kualitas dan higienitas produk daging hingga sampai ke tangan Mitra.
                        </p>
                    </div>
                    ...
                    <div class="pt-6 border-t border-white/20">
                        <p class="text-base md:text-lg leading-relaxed">
                            Bersama Anda, kami yakin <strong>{{ App\Models\Setting::get('company_name', 'UD MAKMUR JAYA DAGING') }}</strong> akan terus tumbuh dan menjadi partner andalan dalam penyediaan produk daging berkualitas di Indonesia.
                        </p>
                    </div>
                </div>
    ...
    <div class="container mx-auto px-4">
        <div class="bg-gradient-to-br from-[#7B0000] to-[#3D0000] rounded-3xl overflow-hidden shadow-lg px-8 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <a href="{{ App\Models\Setting::get('instagram', 'https://instagram.com') }}" 
                   target="_blank"
                   class="bg-white/10 hover:bg-white text-white hover:text-gray-800 font-semibold py-5 px-6 rounded-2xl transition-all duration-300 text-center group border border-white/20 hover:border-transparent hover:shadow-xl">
                ...
                <a href="{{ App\Models\Setting::get('tiktok', 'https://tiktok.com') }}" 
                   target="_blank"
                   class="bg-white/10 hover:bg-white text-white hover:text-gray-800 font-semibold py-5 px-6 rounded-2xl transition-all duration-300 text-center group border border-white/20 hover:border-transparent hover:shadow-xl">
        ...
        <div class="bg-gray-50 rounded-3xl overflow-hidden shadow-lg flex flex-col lg:flex-row" style="min-height: 320px;">
            ...
            <div class="lg:w-72 flex-shrink-0 bg-[#C0392B] text-white p-8 flex flex-col justify-center">
                <div class="mb-6">
                    ...
                    <p class="text-white/80 text-sm leading-relaxed">{{ App\Models\Setting::get('address', 'Jl. Contoh No.1, Kota') }}</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-white/80 text-sm">{{ App\Models\Setting::get('operational_weekday', 'Sen–Kam 05.00–11.00') }}</p>
                    <p class="text-white/80 text-sm">{{ App\Models\Setting::get('operational_saturday', 'Jumat 05.00–10.00') }}</p>
                    <p class="text-white/60 text-sm">{{ App\Models\Setting::get('operational_sunday', 'Minggu 05.00–11.00') }}</p>
                </div>

                <a href="https://maps.google.com/?q={{ urlencode(App\Models\Setting::get('address', '')) }}" 
                   target="_blank"
