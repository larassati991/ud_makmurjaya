        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <a href="https://wa.me/{{ App\Models\Setting::get('whatsapp_number') }}?text=Halo! Saya tertarik untuk info pricelist & order retail" 
                       ...
                       class="block bg-white border-2 border-primary hover:bg-primary hover:text-white p-6 rounded-xl transition group shadow-lg">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1">
                                <h4 class="font-bold text-lg mb-1">{{ App\Models\Setting::get('phone_1_label') }}</h4>
                    ...
                    <!-- Button 2 -->
                    <a href="https://wa.me/{{ App\Models\Setting::get('phone_2', App\Models\Setting::get('whatsapp_number')) }}?text=Halo! Saya tertarik untuk info kerjasama" 
                       target="_blank"
                       class="block bg-white border-2 border-primary hover:bg-primary hover:text-white p-6 rounded-xl transition group shadow-lg">
                        <div class="flex items-center">
                            <div class="bg-green-500 text-white p-4 rounded-lg mr-4 group-hover:bg-white group-hover:text-green-500 transition">
                            ...
                            <div class="flex-1">
                                <h4 class="font-bold text-lg mb-1">{{ App\Models\Setting::get('phone_2_label') }}</h4>
                                <p class="text-sm text-gray-600 group-hover:text-white">Klik untuk chat sekarang</p>
                            </div>
                            <svg class="w-6 h-6 group-hover:translate-x-2 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    ...
                    <!-- Button 3 -->
                    <a href="https://wa.me/{{ App\Models\Setting::get('phone_3', App\Models\Setting::get('whatsapp_number')) }}?text=Halo! Saya ingin menyampaikan pengaduan" 
                       target="_blank"
                       class="block bg-white border-2 border-primary hover:bg-primary hover:text-white p-6 rounded-xl transition group shadow-lg">
                        <div class="flex items-center">
                            <div class="bg-green-500 text-white p-4 rounded-lg mr-4 group-hover:bg-white group-hover:text-green-500 transition">
                            ...
                            <div class="flex-1">
                                <h4 class="font-bold text-lg mb-1">{{ App\Models\Setting::get('phone_3_label') }}</h4>
                                <p class="text-sm text-gray-600 group-hover:text-white">Klik untuk chat sekarang</p>
                            </div>
                            <svg class="w-6 h-6 group-hover:translate-x-2 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
