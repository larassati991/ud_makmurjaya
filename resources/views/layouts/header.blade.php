    ...
    <nav class="container mx-auto px-4 py-3 relative z-10">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center space-x-1">
                ...
                <a href="{{ route('about') }}" 
                   class="text-white hover:bg-white/10 px-5 py-2 rounded-md font-medium transition text-[15px] {{ request()->routeIs('about') ? 'bg-white/20' : '' }}">
                    Profil Perusahaan
                </a>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <a href="{{ route('about') }}" 
               class="block py-2.5 px-4 text-white hover:bg-white/10 rounded-md mb-1 {{ request()->routeIs('about') ? 'bg-white/20' : '' }}">
                Profil Perusahaan
            </a>
